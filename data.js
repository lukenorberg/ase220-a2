/**
 * parameters of any given animals object
 * @typedef {Object} animal
 * @param {number} animal.id
 * @param {boolean} animal.sprayed_or_neutered
 * @param {string} animal.microchip_number
 * @param {string} animal.summary
 * @param {string} animal.type
 * @param {string} animal.breed
 * @param {string} animal.sex
 * @param {string} animal.color
 * @param {string} animal.age
 * @param {string[]} animal.status
 */
...
const animals = [
  ...
  },
  {
    id: 47920,
    sprayed_or_neutered: true,
    microchip_number: "985120031478902",
    summary:
